package com.example.s1091768_csim
...
class MainActivity : AppCompatActivity(), GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, View.OnTouchListener {
    ...
    fun ShowPicture() {
        ...
        var res:Int = getResources().getIdentifier("photo" + PictureNo.toString(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        while (res != 0) {
            countDrawables++;
            res = getResources().getIdentifier("photo" + countDrawables.toString(),
                "drawable", getPackageName());
        }
